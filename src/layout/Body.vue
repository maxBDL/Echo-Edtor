...
<template>
    <div class="flex flex-row w-full">
        ...
        <div class="overflow-x-auto">
            <RowButton v-for="color in colors" :color="color" :key="index" :nbButtons="props.audioDur*props.npb*props.bps"
                @resultRow="rowAssignee($event, color)" />
                <AVWaveform preload="metadata" class="w-screen" :audio-controls="false" :src="props.audioSrc" v-if="props.audioSrc != null" :canv-width="graphWidth"/>
