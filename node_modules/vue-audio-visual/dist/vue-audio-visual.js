...
import { unref as et, getCurrentScope as tt, onScopeDispose as nt, computed as ge, ref as C, watch as V, isRef as xe, shallowRef as ue, watchEffect as be, defineComponent as Y, openBlock as J, createElementBlock as K, Fragment as oe, createElementVNode as D } from "vue";
var Le;
const Ce = typeof window < "u", rt = (n) => typeof n == "string", it = () => {
};
Ce && ((Le = window == null ? void 0 : window.navigator) == null ? void 0 : Le.userAgent) && /iP(ad|hone|od)/.test(window.navigator.userAgent);
function m(n) {
  return typeof n == "function" ? n() : et(n);
}
function Be(n, e = !1, t = "Timeout") {
...
function fe(n) {
  return typeof n == "function" ? ge(n) : C(n);
}
function ye(n, e = !1) {
  function t(s, { flush: h = "sync", deep: g = !1, timeout: p, throwOnTimeout: N } = {}) {
    let P = null;
  ...
  function r(s, h) {
    if (!xe(s))
      return t((z) => z === s, h);
    const { flush: g = "sync", deep: p = !1, timeout: N, throwOnTimeout: P } = h != null ? h : {};
    let H = null;
...
function x(...n) {
  ...
  }, d = (f, s, h) => (f.addEventListener(s, h, i), () => f.removeEventListener(s, h, i)), c = V(() => st(e), (f) => {
...
var ut = Object.defineProperty, dt = Object.defineProperties, ft = Object.getOwnPropertyDescriptors, Oe = Object.getOwnPropertySymbols, ht = Object.prototype.hasOwnProperty, yt = Object.prototype.propertyIsEnumerable, Ne = (n, e, t) => e in n ? ut(n, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : n[e] = t, v = (n, e) => {
  for (var t in e || (e = {}))
...
function gt(n, ...e) {
  ...
  const {
    ...
    initialData: c,
    timeout: u
  } = a, f = de(), s = de(), h = de(), g = C(!1), p = C(!1), N = C(!1), P = C(null), H = ue(null), q = ue(null), M = ue(c), z = ge(() => r && p.value);
  let A, $;
  const Te = () => {
    r && A && A.abort();
  }, ce = (w) => {
  ...
  u && ($ = ct(Te, u, { immediate: !1 }));
  const ee = async (w = !1) => {
    var k;
    ce(!0), q.value = null, P.value = null, N.value = !1, A = void 0, r && (A = new AbortController(), A.signal.onabort = () => N.value = !0, i = E(v({}, i), {
      signal: A.signal
    }));
    const T = {
      method: o.method,
    ...
    if (a.beforeFetch && Object.assign(L, await a.beforeFetch(L)), U || !d)
      return ce(!1), Promise.resolve(null);
    let B = null;
  ...
  function I(w) {
    return (k, T) => {
      if (!p.value) {
        o.method = w, o.payload = k, o.payloadType = T, xe(o.payload) && V([
          He,
          fe(o.payload)
        ], ([L]) => L && ee(), { deep: !0 });
        const U = m(o.payload);
  ...
  function se() {
    return new Promise((w, k) => {
      lt(g).toBe(!0).then(() => w(te)).catch((T) => k(T));
    });
  }
  function R(w) {
    return () => {
...
var Ct = Object.defineProperty, ze = Object.getOwnPropertySymbols, St = Object.prototype.hasOwnProperty, Wt = Object.prototype.propertyIsEnumerable, Ee = (n, e, t) => e in n ? Ct(n, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : n[e] = t, Ft = (n, e) => {
  for (var t in e || (e = {}))
...
const qt = ["controls", "src"], $t = /* @__PURE__ */ Y({
  __name: "AVBars",
  props: Pt(),
  setup(n) {
    const e = n, t = C(null), r = C(null);
    return zt(t, r, e), (i, a) => (J(), K(oe, null, [
      D("audio", {
        ref_key: "player",
        ref: t,
...
const Ut = ["controls", "src"], Qt = /* @__PURE__ */ Y({
  __name: "AVCircle",
  props: At(),
  setup(n) {
    const e = n, t = C(null), r = C(null);
    return It(t, r, e), (i, a) => (J(), K(oe, null, [
      D("audio", {
        ref_key: "player",
        ref: t,
        controls: e.audioControls,
...
const Yt = ["controls", "src"], Jt = /* @__PURE__ */ Y({
  __name: "AVLine",
  props: Ht(),
  setup(n) {
    const e = n, t = C(null), r = C(null);
    return Xt(t, r, e), (i, a) => (J(), K(oe, null, [
      D("audio", {
        ref_key: "player",
        ref: t,
        controls: e.audioControls,
...
const tn = ["controls", "src"], nn = /* @__PURE__ */ Y({
  __name: "AVWaveform",
  props: Bt(),
  setup(n) {
    const e = n, t = C(null), r = C(null);
